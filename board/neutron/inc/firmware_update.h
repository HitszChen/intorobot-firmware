...
class FirmwareUpdateClass
{
    public:
        ...
        bool openwrt_firmware_version(char *p_version);
        bool openwrt_firmware_down(const char *app_id, const char *server_addr);
        bool openwrt_firmware_update(void);
        bool openwrt_firmware_isupdate(void);
        bool openwrt_firmware_clearupdate(void);
