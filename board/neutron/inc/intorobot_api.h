...
#define INTOROBOT_MQTT_RESMES_OW_FWUPREADY    "40"  //openwrt ready firmware down
#define INTOROBOT_MQTT_RESMES_OW_FWDOWNFAIL   "41"  //openwrt firmware down failed
#define INTOROBOT_MQTT_RESMES_OW_FWDOWNSUCC   "42"  //openwrt firmware down success
#define INTOROBOT_MQTT_RESMES_OW_FWUPFAIL     "43"  //openwrt firmware update failed
#define INTOROBOT_MQTT_RESMES_OW_FWUPSUCC     "44"  //openwrt firmware update success
...
//#define INTOROBOT_MQTT_OW_UPDATETOPIC   "openwrt/default/action/flash"
...
#define INTOROBOT_BOARD_TYPE1    "888002" //sevice info
