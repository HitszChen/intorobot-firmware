...
/*********************************************************************************
  ...
  *Others		:
**********************************************************************************/
bool FirmwareUpdateClass::openwrt_firmware_version(char *p_version)
{
/*
    String tmp;
    ...
    int res = run();
*/
    int res=mo_FirmwareUpdateClass_openwrt_firmware_version_hal(p_version);
...
/*********************************************************************************
  ...
  *Others		:
**********************************************************************************/
bool FirmwareUpdateClass::openwrt_firmware_down(const char *app_id, const char *server_addr)
{
...
/*
    ...
    int res=mo_FirmwareUpdateClass_openwrt_firmware_down(app_id, server_addr);
    if(res == 0)
    {
        return true;
    }
...
{/*
    ...
    int res=mo_FirmwareUpdateClass_openwrt_firmware_update_hal();
    if(res == 0)
    {
        return true;
    }
...
/*********************************************************************************
  ...
  *Others		:
**********************************************************************************/
bool FirmwareUpdateClass::openwrt_firmware_isupdate(void)
{/*
    begin("openwrt_update_online");
    addParameter("ISUPDATE");
    int res = run();*/

    int res= mo_FirmwareUpdateClass_openwrt_firmware_isupdate();
    if(res == 0)
    {
        return true;
    }
...
/*********************************************************************************
  ...
  *Others		:
**********************************************************************************/
bool FirmwareUpdateClass::openwrt_firmware_clearupdate(void)
{
/*
    begin("openwrt_update_online");
    addParameter("CRUPDATE");
    int res = run();*/
    int res= mo_FirmwareUpdateClass_openwrt_firmware_clearupdate();
    if(res == 0)
    {
        return true;
    }
