...
#define CACHE_RESERVER_SEC_START         256  //保留区  缓冲起始扇区
#define CACHE_ESP8266_APP_SEC_START      264  //esp8266程序和在线应用程序 缓冲扇区地址
#define CACHE_DEF_STM32_APP_SEC_START    444  //stm32默认固件 缓冲扇区地址

#define CACHE_RESERVER_SEC_NUM           8    //保留区  缓冲扇区总个数
