#if 1
#include "application.h"		//基础头文件


#include "my_led_test.h"		//用户头文件测试


#include "DHT22_lib_usr_test1/DHT22_lib_usr_test1.h"		//用户库1头文件测试
#include "DHT33_lib_usr_test2/DHT33_lib_usr_test2.h"		//用户库2头文件测试


#include "DHT00_lib_public_test1/DHT00_lib_public_test1.h"		//公共库1头文件测试
#include "DHT11_lib_public_test2/DHT11_lib_public_test2.h"		 //公共库2头文件测试
